...
// В конфигурации хранятся не только продолжитеьности интервалов,
// но и репозиторий - то есть, по сути, и механизм хранения данных
// - вот это не сразу при чтении книжки уложилось
